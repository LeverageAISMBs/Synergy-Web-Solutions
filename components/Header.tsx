      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">
            <a href="#home" onClick={(e) => { e.preventDefault(); setCurrentPage('Home'); }} className="block leading-tight">
              <span className="text-2xl font-bold text-indigo-600">Synergy Web Solutions</span>
              <span className="block text-xs text-slate-500">Powered by LEVERAGEAI LLC</span>
            </a>
          </div>
