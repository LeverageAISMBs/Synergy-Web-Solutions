...
const FeatureCard: React.FC<{
  ...
  <div
    className={`bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 transform hover:-translate-y-2 ${className}`}
    style={style}
  >
...
const Home: React.FC<HomeProps> = ({ setCurrentPage }) => {
  ...
  const testimonials = [
    {
      quote: "Synergy Web Solutions transformed our online presence. Their attention to detail and commitment to quality is unparalleled. We saw a 200% increase in engagement!",
      author: "Jane Doe",
      title: "CEO, Innovate Inc.",
      avatarUrl: "https://picsum.photos/seed/avatar1/100/100"
    },
    {
      quote: "The team was a pleasure to work with. They delivered a beautiful, high-performance website on time and on budget. Highly recommended!",
      author: "John Smith",
      title: "Founder, Tech Startups",
      avatarUrl: "https://picsum.photos/seed/avatar2/100/100"
    },
    {
      quote: "Their UI/UX design process is fantastic. They truly understand user needs and create interfaces that are both functional and stunningly beautiful.",
      author: "Samantha Lee",
  ...
  const features = [
    {
        ...
        description: "Leveraging the latest frameworks like React, Next.js, and TypeScript to build scalable and maintainable applications."
    },
    {
        title: "User-Centric Design",
        icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>,
        description: "Our UI/UX experts create intuitive and engaging interfaces that delight users and drive conversions."
    },
    {
        title: "Performance Optimized",
        icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>,
        description: "We ensure your website is lightning-fast, SEO-friendly, and accessible to everyone, on any device."
    }
  ];
      ...
      <section className="bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 text-center">
          ...
          <div className="flex justify-center gap-4">
            ...
            <Button variant="secondary" onClick={() => setCurrentPage('Services')}>Our Services</Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-slate-600">Trusted by innovative companies worldwide.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
